...
export const invitation = (prop) => html`
    ...
    <section id="program">
      ...
      <article>
        <img src="src/assets/images/cheers.png" alt="Питиета" class="icon">
        <h3>18:00 часа</h3>
      ...
      <div class="map-heading">
        <img class="separator" src="src/assets/images/border.png" alt="">
    ...
    <section id="contacts">
      ...
      <div class="contacts-content">
        ...
        <img class="separator" src="src/assets/images/border-white.png" alt="">
        <div class="row">
          <div class="church">
